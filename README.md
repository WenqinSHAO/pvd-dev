...
```
        ...
        |         |          |    +--+-------+---------------+-------+       +----------------+    |
        |         |          |    |               pvdd               +-------+   pvd-monitor  +-------------------------------+
        |         |          |    +-----------------+----------------+       +----------------+    | extra net service info   |
        |         |          |                      |                                              |                          |
        +------------------------------------------------------------------------------------------+                          |
        |         +          +                      +                                              |                          |
        |       parse RA; attach prefix, route to PvDs; select saddr, route with PvD compliance    |                          |
        |       register, announce PvD updates via rtnetlink                                       |                          |
        |       bind socket/thread/socket to PvDs via set/getsockopt                       kernel  |                          |
        +-------------------+---------------------------------+------------------------------------+                          |
               real traffic |                                 |                                                               |
                            |                                 |                                                               |
                            |                                 |                     +--------------+                          |
...
+----------------------------------------------------------------------------------------------------------------------------------------------------+
 network                    |                                 |                                                               |
           +----------------+----------------+                |                                               +---------------+-------------+
           | Source Adress Dependant Routing |       +--------+---------+                                     | pvd additional info server  |
           |            (SADR)               |       |   radvd/odhcpd   |                                     | (captive portal, perf, etc) |
           +---------------------------------+       +------------------+                                     +-----------------------------+
